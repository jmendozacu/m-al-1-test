...
define('BP', "/home/vagrant/homestead/html/m1-testing-environment/");
...
class SheroTest
{
    ...
    public function __construct() {
        ...
        $this->_sheroDir    = $this->_codeDir . DS . 'local';
    ...
    protected function checkDisableModulesOutput() {
        ...
        $result = mysqli_query($this->mysqlConnect(), $query) or die (mysql_error());
    ...
    protected function mysqlConnect() {
        if(!$this->_mysqlConnect) {
            ...
            $this->_mysqlConnect = mysqli_connect(
                (string)$dbParams->host,
                (string)$dbParams->username,
                (string)$dbParams->password,
                (string)$dbParams->dbname
            ) or die(mysql_error());
        }
...
class AmastyStat
{
    ...
    protected function mysqlConnect() {
        ...
        if(!$this->_mysqlConnect) {
            ...
            $this->_mysqlConnect = mysqli_connect(
                ...
                (string)$dbParams->username,
                (string)$dbParams->password,
                (string)$dbParams->dbname) or die(mysql_error());
        }
    ...
    protected function query($query, $params = array()){
        ...
        foreach($params as &$param){
            $param = "'".mysqli_real_escape_string($this->mysqlConnect(), $param)."'";
        }
